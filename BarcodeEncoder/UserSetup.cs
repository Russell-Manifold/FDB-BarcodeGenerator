...
namespace BarcodeEncoder
{
    ...
    private void BtnPrint_Click(object sender, EventArgs e)
        ...
        private void GetAllUsers()
        {
            ...
            client.BaseUrl = new Uri(BarcodeEncoder.Properties.Settings.Default.API + path);
            {
                ...
                if (res.IsSuccessful)
                {
                    ...
                    DDUserName.DataSource = ds.Tables[0];
                    DDUserName.DisplayMember = "UserName";
                    DDUserName.ValueMember = "UserNumber";
                }
        ...
        private void btnSaveLocation_Click(object sender, EventArgs e)
        {
            ...
            {
                Qstr = "UPDATE dbo.tblUser SET UserName = '" + DDUserName.Text.ToString() + "' ,UserBarcode = '" + txtPwd.Text.ToString() + "', iJobTitleCode = '" + ddJobTitles.Text.ToString() + "', isActive = '" + togActive.Checked + "' WHERE UserNumber = '" + txtUserNumber.Text + "'";
            }
            else
            {
